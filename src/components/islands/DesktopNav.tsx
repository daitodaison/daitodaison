            ...
            {link.children ? (
              <button
                className={`flex items-center gap-1 text-sm font-medium transition-colors bg-transparent border-0 cursor-pointer p-0 ${
                  hoveredIndex === index || isLinkActive ? 'text-white dark:text-blue-300' : 'text-white/80 hover:text-white dark:text-white dark:hover:text-blue-300'
                }`}
              ...
              >
                ...
                <a 
                    ...
                    className={`text-sm font-medium transition-colors ${
                        isLinkActive ? 'text-white dark:text-blue-300' : 'text-white/80 hover:text-white dark:text-white dark:hover:text-blue-300'
                    }`}
                >
                    {link.label}
                </a>
